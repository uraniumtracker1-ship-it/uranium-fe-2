  ...
  useEffect(() => {
    const fetchPrices = async () => {
      try {
        ...
        // Sort data to ensure Uranium comes first
        const sortedData = data.sort((a, b) => {
          if (a.metal_name === "Uranium") return -1;
          if (b.metal_name === "Uranium") return 1;
          return 0;
        });
...
export default HomeUraniumPrice;
