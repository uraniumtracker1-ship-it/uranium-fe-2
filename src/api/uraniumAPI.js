export const BASE_URL = process.env.NEXT_PUBLIC_API_BASEURL || 'https://uraniumdjango-production.up.railway.app';

//HOME & NEWS APIS

export const URANIUM_NEWS = `${BASE_URL}/api/uranium_news/`;

export const SPORT_PRICE_CHART = `${BASE_URL}/api/spot-price-chart/`;

export const URANIUM_PRICES = '/api/uranium-prices';

export const URANIUM_PRICES_EXTENDED = '/api/uranium-prices-extended';
...
export const URANIUM_STOCK_DETAIL = `${BASE_URL}/api/uranium-stock-detail/`;
